  ...
  return (
    <Container>
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://dogeswap.co/">
          https://dogeswap.co/
        </Link>
        <Text as="span">
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://dogeswap.co//terms-of-service">
          https://dogeswap.co//terms-of-service.
        </Link>
        <Text as="span">
